    ...
    <div className="container">
      ...
      >
        ...
        <p className="text-muted-foreground text-lg mb-3">
          I'm always open to interesting conversations — whether it's about a role, a project, or just ML in general.
        </p>
        <p className="text-sm text-warm-glow italic mb-10">
          Always learning and improving — especially in real-world AI applications 🚀
        </p>
        ...
        <div className="rounded-xl border border-border bg-card p-6">
          ...
          <div className="flex flex-wrap justify-center gap-2">
            {["LLM Agents", "Multimodal AI", "Edge Inference", "RAG Systems"].map((topic) => (
              <span key={topic} className="font-mono text-xs rounded-full border border-primary/20 bg-primary/5 px-3 py-1.5 text-primary">
                {topic}
              </span>
            ))}
          </div>
